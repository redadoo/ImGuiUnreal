...
#include "UnrealImgGui/Public/Test.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeTest() {}

// Begin Cross Module References
ENGINE_API UClass* Z_Construct_UClass_AActor();
UNREALIMGGUI_API UClass* Z_Construct_UClass_ATest();
UNREALIMGGUI_API UClass* Z_Construct_UClass_ATest_NoRegister();
...
template<> UNREALIMGGUI_API UClass* StaticClass<ATest>()
{
	return ATest::StaticClass();
}
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Users_edoar_Desktop_Github_ImGuiUnreal_UnrealImgGui_Source_UnrealImgGui_Public_Test_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ATest, ATest::StaticClass, TEXT("ATest"), &Z_Registration_Info_UClass_ATest, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ATest), 3226319742U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_edoar_Desktop_Github_ImGuiUnreal_UnrealImgGui_Source_UnrealImgGui_Public_Test_h_2835715759(TEXT("/Script/UnrealImgGui"),
	Z_CompiledInDeferFile_FID_Users_edoar_Desktop_Github_ImGuiUnreal_UnrealImgGui_Source_UnrealImgGui_Public_Test_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_edoar_Desktop_Github_ImGuiUnreal_UnrealImgGui_Source_UnrealImgGui_Public_Test_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
